        ...
        <nav class="mt-2">
            ...
            <!-- Add icons to the links using the .nav-icon class
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="/admin/truyen/add" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Thêm Truyện</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/admin/truyen/list" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="/admin/chuong/add" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Thêm Chương</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/admin/chuong/list" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="/admin/photo/add" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Thêm Hình ảnh</p>
                            </a>
                        </li>
